...
const STEPS = [
  {
    num: "01",
    title: "Nueva orden",
    desc: "Mesa, nombre y WhatsApp opcional",
    file: "mesero/movil",
    lang: "bash",
    code: [
      { type: "comment", text: "# Crear pedido" },
      { type: "command", text: "mesa 04 --whatsapp 3001234567" },
      { type: "gap" },
      { type: "comment", text: "# Agregar productos" },
      { type: "command", text: "add brownie helado x2" },
      { type: "gap" },
      { type: "output", text: "Pedido creado" },
      { type: "output", text: "Caja notificada" },
      { type: "output", text: "Cocina en espera" },
    ],
  },
  {
    num: "02",
    title: "Caja revisa",
    desc: "Confirma y envia a cocina",
    file: "caja/panel.ts",
    lang: "typescript",
    code: [
      { type: "comment", text: "// pedido confirmado" },
      { type: "keyword", text: "const", after: " orden ", keyword2: "=", keyword3: " new ", fn: "Pedido", args: "({" },
      { type: "gap" },
      { type: "prop", key: "  mesa", val: "'04'" },
      { type: "prop", key: "  estado", val: "'en_cocina'" },
      { type: "prop", key: "  total", val: "'$38.000'" },
      { type: "prop", key: "  canal", val: "'WhatsApp'" },
      { type: "plain", text: "});" },
    ],
  },
  {
    ...
    desc: "Pedidos ordenados con timer",
    file: "cocina/pantalla.ts",
    lang: "typescript",
    code: [
      { type: "comment", text: "// Cola de preparacion" },
      { type: "keyword", text: "const", after: " siguiente ", keyword2: "=", keyword3: " new ", fn: "OrdenCocina", args: "({" },
      { type: "gap" },
      { type: "prop", key: "  prioridad", val: "'llegada'" },
      { type: "prop", key: "  timer", val: "'06:42'" },
      { type: "prop", key: "  productos", val: "'4 items'" },
      { type: "gap" },
      { type: "plain", text: "siguiente.marcarLista()" },
    ],
  },
  {
    num: "04",
    title: "Cliente avisado",
    desc: "Alerta a mesero y WhatsApp",
    file: "whatsapp/envio",
    lang: "bash",
    code: [
      { type: "comment", text: "# Pedido listo" },
      { type: "command", text: "moka pedido:completar MKA-042" },
      { type: "gap" },
      { type: "output", text: "  Alertando al mesero..." },
      { type: "output", text: "  Enviando WhatsApp..." },
      { type: "output", text: "  Generando ticket PDF..." },
      { type: "gap" },
      { type: "success", text: "Pedido entregable" },
      { type: "url", text: "  https://moka.app/pedido/MKA-042" },
    ],
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
            Hecho para el ritmo<br />real de una heladeria.
          </h2>
        </div>
