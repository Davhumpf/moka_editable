...
const AGENTS = [
  {
    label: "COMUNICACION",
    title: "Sin papel y sin gritos",
    desc: "El pedido pasa del celular del mesero a caja y cocina en tiempo real. Todos ven el estado correcto sin depender de notas sueltas.",
    stats: [{ v: "1 clic", l: "a cocina" }, { v: "0", l: "papeles" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/researcher-CvhqOuV6irGwBOnJoTGFlXdbyYBRjb.png",
  },
  {
    label: "CLIENTE",
    title: "WhatsApp cuando esta listo",
    desc: "El cliente deja de esperar a ciegas. Cuando el pedido queda listo, recibe un mensaje directo sin descargar apps ni crear cuentas.",
    stats: [{ v: "1 msg", l: "automatico" }, { v: "0", l: "friccion" }],
  ...
  },
  {
    ...
    desc: "Moka guarda cada venta, producto y horario para que el dueno sepa que se vendio, cuando se lleno el local y que se agoto primero.",
    stats: [{ v: "24/7", l: "historial" }, { v: "1", l: "reporte diario" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/analyst-Ysxnqg7Fpy2cfA56PiIttv1KximMhT.png",
  },
  {
    label: "FACTURACION",
    title: "Ticket o factura en PDF",
    desc: "La caja genera el comprobante con un clic y lo envia por WhatsApp o lo imprime en la termica cuando el cliente lo necesita.",
    stats: [{ v: "PDF", l: "al instante" }, { v: "1 clic", l: "para enviar" }],
