    ...
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen font-sans antialiased">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 z-30 flex flex-col px-6 md:px-12 pb-12 max-w-3xl">
          ...
          <div className="flex gap-8 sm:gap-12">
            {[
              { value: "<30s", label: "Toma de pedido" },
              { value: "1 clic", label: "A cocina" },
              { value: "WhatsApp", label: "Cliente avisado" },
            ].map((stat, i) => (
              <div
                key={i}
                style={{
      ...
      <section id="platform" className="py-32 px-6 md:px-12 lg:px-20">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <div className="mt-4"><Tag>QUE ES MOKA</Tag></div>
          ...
          <div className="grid grid-cols-12 grid-rows-auto gap-3" onMouseMove={handleMouse}>
            ...
            <BentoCard className="col-span-12 p-8 min-h-[200px] flex flex-col justify-between relative overflow-hidden" delay={0}>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-light mb-3">No es un POS generico</h3>
                <p className="text-sm text-black/45 leading-relaxed max-w-sm">
                  Moka es una herramienta quirurgica para heladerias pequenas: pocos meseros, mucho movimiento y cero tiempo para aprender software complicado.
                </p>
              </div>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={120}>
              ...
              <h3 className="text-lg font-light mb-2">Pedidos en tiempo real</h3>
              <p className="text-sm text-black/45 leading-relaxed">Mesero, caja y cocina ven el mismo estado sin pasar papeles ni repetir instrucciones.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={160}>
              ...
              <h3 className="text-lg font-light mb-2">Catalogo visual</h3>
              <p className="text-sm text-black/45 leading-relaxed">Fotos, precios y categorias en el celular del mesero para tomar ordenes con un toque.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={200}>
              ...
              <h3 className="text-lg font-light mb-2">Reportes automaticos</h3>
              <p className="text-sm text-black/45 leading-relaxed">El dueno sabe cuanto vendio, que producto se movio mas y en que horas se llena el local.</p>
            </BentoCard>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              ...
              <div className="mt-4"><Tag>PROBLEMAS</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
                {"El caos del papel\nvuelto flujo claro."}
              </RevealText>
            </div>
            <p className="text-sm text-black/45 leading-relaxed max-w-xs">
              Moka ataca la comunicacion rota, la espera sin informacion, la toma lenta de pedidos, la poca visibilidad del dueno y la facturacion manual.
            </p>
          </div>
      ...
      <section id="workflow" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <div className="mt-4"><Tag>FLUJO REAL</Tag></div>
            <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
              {"Del cliente a cocina\ny de vuelta a WhatsApp."}
            </RevealText>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-3" onMouseMove={handleMouse}>
            {[
              { n: "01", title: "Mesero toma",  desc: "Abre la app, elige mesa, nombre o WhatsApp opcional y agrega productos desde el catalogo visual.", delay: 0,   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/define-5aafAmGBrxZpOqJ3XLHY3n3qzC2I5K.png" },
              { n: "02", title: "Caja envia", desc: "La orden llega al computador de caja, se revisa y se manda a cocina con un clic.", delay: 80,  img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/compose-5RT5VR4f1Y3GoFmovqTKLTG4UXp3g2.png" },
              { n: "03", title: "Cocina ve",    desc: "Los pedidos aparecen ordenados por llegada, con timer y detalles claros para preparar sin dudas.", delay: 140, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/test-zm8guZwxJHtwWsJ7XO4B0CF7GzlNK8.png" },
              { n: "04", title: "Moka avisa",  desc: "Al completar el pedido, el mesero recibe alerta y el cliente recibe mensaje por WhatsApp.", delay: 200, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/deploy-an8fgHSLzniojkcmRyGGIFQUJF9T5J.png" },
            ].map((step) => (
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              ...
              <div className="mt-4"><Tag>WHATSAPP Y FACTURA</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
                {"El cliente sabe\ncuando su pedido esta listo."}
              </RevealText>
            </div>
            <p className="text-sm text-black/45 leading-relaxed max-w-xs">
              Sin apps, sin cuentas y sin friccion: Moka envia avisos por WhatsApp y permite mandar el ticket o factura en PDF cuando el cliente lo solicita.
            </p>
          </div>
          ...
          <div className="rounded-2xl overflow-hidden border border-black/[0.07] flex flex-col md:block md:relative" onMouseMove={handleMouse}>
            ...
            <div className="flex flex-col gap-3 p-4 md:absolute md:bottom-4 md:right-4 md:p-0 md:w-72">
              ...
              >
                <Tag>TICKET</Tag>
                <h3 className="mt-3 text-lg font-light mb-2">Factura en PDF</h3>
                <p className="text-xs text-black/45 leading-relaxed mb-4">Caja genera el comprobante y lo envia por WhatsApp o lo imprime en la termica.</p>
                <div className="bg-black/[0.05] rounded-lg border border-black/[0.07] p-3 font-mono text-[11px] text-black/50 leading-relaxed">
                  <span className="text-black/25">// factura solicitada</span><br />
                  <span className="text-blue-600/70">crearPDF</span>{"({"}<br />
                  {"  "}<span className="text-amber-700/70">pedido</span>: <span className="text-green-700/70">&apos;MKA-042&apos;</span>,<br />
                  {"  "}<span className="text-amber-700/70">enviar</span>: <span className="text-black/35">async () </span>={">"}<br />
                  {"    "}<span className="text-blue-600/70">whatsapp</span>.send(pdf)<br />
                  {"})"}
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-black/40 tracking-widest">LISTO</span>
                </div>
                <p className="text-sm text-black/45">Pedido completado, mesero alertado y cliente notificado en el mismo momento.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="security" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            <PixelIcon type="platform" size={40} />
            <div className="mt-4"><Tag>PARA QUIEN ES</Tag></div>
            <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
              {"Para negocios pequenos\nque quieren mejorar ya."}
            </RevealText>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <p className="text-sm text-black/45 leading-relaxed">
                Moka esta pensado para heladerias y negocios de comida rapida pequenos o medianos: 1 a 4 meseros, una caja, una cocina y mucho movimiento.
              </p>

              <div className="space-y-4">
                {[
                  { label: "Cliente ideal", desc: "Hoy usa papel o ningun sistema y quiere ordenar su operacion sin capacitar un mes." },
                  { label: "WhatsApp Business", desc: "Ya se comunica por WhatsApp, pero todavia no automatiza avisos ni facturas." },
                  { label: "No es para todos", desc: "Cadenas con ERP, negocios sin dispositivos digitales o restaurantes con flujos muy complejos." },
                ].map((item) => (
              ...
              <div className="pt-4 flex flex-col gap-2">
                {["1 a 4 meseros", "1 caja", "1 cocina", "catalogo visual"].map((badge) => (
            ...
            <BentoCard className="p-6 lg:row-span-1" delay={0}>
              <div className="text-xs text-black/30 tracking-widest uppercase mb-4">Valor por rol</div>
              <div className="space-y-2">
                {[
                  { time: "DUENO", action: "Sabe que pasa en su negocio sin preguntar a nadie.", status: "success" },
                  { time: "CAJERO", action: "Nunca mas grita a cocina. Un clic y listo.", status: "success" },
                  { time: "MESERO", action: "El celular le avisa cuando llevar el pedido.", status: "success" },
                  { time: "CLIENTE", action: "Pide, espera tranquilo y recibe aviso por WhatsApp.", status: "success" },
                  { time: "COCINA", action: "Ve pedidos ordenados por llegada, con timer.", status: "success" },
                ].map((log, i) => (
                  <div
                    key={i}
      ...
      <section className="py-0 border-t border-black/[0.06] overflow-hidden select-none">
        <div className="flex border-b border-black/[0.06]" style={{ animation: "marqueeLeft 28s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Pedidos en tiempo real", "Catalogo visual", "WhatsApp automatico", "Caja conectada", "Cocina con timer", "Factura PDF", "Ticket termico", "Reportes diarios", "Inventario", "Mesa y domicilio"].map((cap) => (
        ...
        <div className="flex" style={{ animation: "marqueeRight 22s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Menos errores", "Sin papel", "Sin gritos", "Cliente informado", "Mesero alertado", "Dueno con datos", "Productos agotados", "Ventas por hora", "WhatsApp Business", "Cierre del dia"].map((cap) => (
                <div key={cap} className="flex items-center gap-6 px-10 py-5 border-r border-black/[0.06] shrink-0">
      ...
      <section id="live" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <PixelIcon type="agents" size={40} />
              <div className="mt-4"><Tag>EN VIVO</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.05]">
                {"Cada pedido visible\nde punta a punta."}
              </RevealText>
              <p className="mt-6 text-base text-black/40 leading-relaxed max-w-sm">
                En una heladeria pequena, el problema no es la gente: es la coordinacion. Moka muestra que se pidio, donde esta y quien debe actuar.
              </p>
              <div className="mt-10 flex items-end gap-2">
                <LiveAgentCounter />
                <span className="text-black/30 text-sm mb-1 tracking-wide">pedidos gestionados</span>
              </div>
            </div>
      ...
      <section id="pricing" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16 flex flex-col items-center">
            ...
            <div className="mt-4"><Tag>PLANES</Tag></div>
            <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
            ...
            {[
              {
                name: "Inicio",
                price: "Demo",
                sub: "Para probar el flujo",
                features: ["Catalogo visual", "Toma de pedidos", "Panel de caja", "Vista de cocina"],
                delay: 0,
              },
              {
                name: "Heladeria",
                price: "$49",
                period: "/mo",
                sub: "Para operar sin papel",
                features: ["Meseros ilimitados", "WhatsApp al cliente", "Ticket o factura PDF", "Reportes automaticos", "Productos agotados", "Soporte prioritario"],
                highlight: true,
                delay: 80,
              },
              {
                name: "A medida",
                price: "Custom",
                sub: "Para flujos especiales",
                features: ["Multiples sedes", "Impresora termica", "Ajustes de factura", "Migracion de catalogo", "Capacitacion", "Integraciones"],
                delay: 140,
              },
            ].map((plan) => (
              <BentoCard
              ...
              >
                ...
                <button className={`w-full py-3 rounded-xl text-sm tracking-widest transition-all duration-200 ${
                  ...
                  {plan.name === "A medida" ? "CONTACTAR" : "EMPEZAR"}
                </button>
              </BentoCard>
            ))}
          </div>
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          {!submitted ? (
            ...
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-emerald-600/20 bg-emerald-50 text-emerald-700 text-sm">
              ...
              {"Listo. Te contactaremos para mostrarte Moka."}
            </div>
          )}
        </div>
      </section>
      ...
      <footer className="py-10 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <span className="font-pixel text-xs tracking-[0.25em] text-black/50">MOKA</span>

          {/* Nav sections */}
          <div className="flex flex-wrap items-center gap-x-8 gap-y-3">
            {[
              { label: "Moka",       href: "#platform" },
              { label: "Problemas",  href: "#agents" },
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-black/[0.04]">
          <span className="text-xs text-black/20">Moka designed by Davhumpf with❤️</span>
        </div>
      </footer>
    </div>
  )
